...
5. ~~Subir targetSdk para API 36 (Android 16) antes de 31/ago/2026.~~ ✓ v1.0.0+23 gerada via GitHub Actions (2026-08-02) — falta subir no Teste Interno do Play Console, validar que abre sem crash, e promover para produção.
